...
def count_tokens_from_str(source_str, token_delim=' ', seq_delim='\n',
    ...
    delimiters. The list of special characters can be found at https://docs.python.org/3/library/re.html.
    ...
    counter_to_update : collections.Counter or None, default None
        The collections.Counter instance to be updated with the token counts of :attr:`source_str`. If
        None, return a new collections.Counter instance counting tokens from :attr:`source_str`.


    Returns
    -------
    collections.Counter
        The :attr:`counter_to_update` collections.Counter instance after being updated with the token
        counts of :attr:`source_str`. If :attr:`counter_to_update` is None, return a new collections.Counter
        instance counting tokens from :attr:`source_str`.
